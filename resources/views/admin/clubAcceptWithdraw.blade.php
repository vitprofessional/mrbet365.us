...
@section('admincontent')
                ...
                @else
                @php
                    $profile    = \App\Models\BettingClub::find($getData->club);
                ...
                @endphp
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="min-width:150px">
                                        <a href="{{ route('clubProcessWithdraw',['id'=>$getData->id]) }}" class="btn btn-danger btn-sm"><i class="fas fa-check-square" title="Lock for Processing"></i></a>
                                        <a href="{{ route('clubRejectWithdraw',['id'=>$getData->id]) }}" class="btn btn-warning btn-sm"><i class="fas fa-window-close" title="Reject Withdrawal"></i></a>
                                    </td>
                        ...
                        <form class="form col-4" method="POST" action="{{ route('clubConfirmWithdraw') }}">
                            {{ csrf_field() }}
