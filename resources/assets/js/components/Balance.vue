<template>
<div>
    <div class="col-4 col-md-2 text-center mx-auto text-uppercase category-title" v-if="categoryname !='null'">{{ categoryname}}</div>
   <div v-for="(val,key) in betData">
        <div class="col-4 col-md-2 text-center mx-auto text-uppercase category-title" v-if="val.name !='null' && categoryname =='null'">{{ val.name }}</div>
        <div v-if="val.matchNull=='null'" class="bg-category">
            <div class="alert">
                No live betting available now in {{ val.name }}
            </div>
        </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body bet-data">
                                                            <div v-if="val.sessionUser != null">
                                                                <div class="row" v-if="fqVal.status == 1">
                                                                    <form method="post" :action="val.fqSubmitUrl" class="form col-12 col-md-10 mx-auto">
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <div class="input-group mb-3 row">
                                                                                ...
                                                                                <span class="input-group-text col-8">Est. Return {{(betAmount*team.value).toFixed(2)}}</span>
                                                                            </div>
                                                                        </ul>
                                                                        <div class="p-2">
                                                                            <div class="d-grid gap-2">
                                                                                <button type="submit" class="btn btn-dark btn-sm btn-fluid fw-bold" id="placeBet" style="font-size:1.2rem">Place Bet</button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                    ...
                                    <div class="col-6 col-md-4"  v-for="(answer,aindex) in cqVal.customAnswer">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body bet-data">
                                                    <div v-if="val.sessionUser != null">
                                                        <div class="row" v-if="cqVal.status == 1">
                                                            <form method="post" :action="val.cqSubmitUrl" class="form col-12 col-md-10 mx-auto">
                                                                <input type="hidden" name="_token" :value="val.csrf_field" />
                                                                <ul>
                                                                    <li class="fw-bold text-warning">Minimum bet amount {{ val.SD.minBet }}   & Maximum {{ val.SD.maxBet }}</li>
...
<script>
    export default {
        ...
        mounted() {
            ...
            //console.log('mahedi',this.catagory);
        

        },
        methods: {
            fetchLeaderboard() {
                //console.log('fetch ==',this.catagory)
                axios.get(`/broadcast/${this.catagory}`).then((response) => {
