                                                                            ...
                                                                            <div class="row" v-if="fqVal.status == 1" :id="'fqForm'+fqVal.id+tindex">
                                                                                <form method="post" action="javascript:void(0)" class="form col-12 col-md-10 mx-auto">
                                                                                    ...
                                                                                    <ul>
                                                                                        ...
                                                                                        <input type="hidden" name="quesId" :value="fqVal.id">
                                                                                        <input type="hidden" name="answerId" :value="fqVal.quesId">
                                                                                        <input type="hidden" name="answer" :value="team.name">
                                                                                        <input :id="'answerRate'+fqVal.id+tindex" type="hidden" name="answerRate" :value="team.value">
                                                                                        <input type="hidden" name="matchId" :value="mlVal.id">
                                                                                        <input type="hidden" name="tournament" :value="mlVal.tournament">
                                                                                        <div class="input-group mb-3 row">
                                                                                            <input required type="number" class="form-control col-4" placeholder="0" name="betAmount" :id="'betAmount'+fqVal.id+tindex" v-model="betAmount" :min="val.SD.minBet" :oninput="'estAmtCount('+fqVal.id+tindex+')'" :max="val.SD.maxBet" value="">
                                                                                            <span class="input-group-text col-8">Est. Return &nbsp;<b :id="'estReturn'+fqVal.id+tindex">0.00</b></span>
                                                                                        </div>
                                                                                    </ul>
                                                                                    <div class="p-2">
                                                                                        <div class="d-grid gap-2">
                                                                                            <button :id="'betBtn'+fqVal.id+tindex" type="submit" class="btn btn-dark btn-sm btn-fluid fw-bold"  
                                                                            ...
                                                                            <div class="row" v-if="fqVal.status == 1" :id="'fqForm'+fqVal.id+3">
                                                                                <form method="post" action="javascript:void(0)" class="form col-12 col-md-10 mx-auto">
                                                                                    ...
                                                                                    <ul>
                                                                                        ...
                                                                                        <input :id="'answerRate'+fqVal.id+3" type="hidden" name="answerRate" :value="fqVal.draw">
                                                                                        <input type="hidden" name="matchId" :value="mlVal.id">
                                                                                        <input type="hidden" name="tournament" :value="mlVal.tournament">
                                                                                        <div class="input-group mb-3 row">
                                                                                            <input required type="number" class="form-control col-4" :id="'betAmount'+fqVal.id+3" placeholder="0" name="betAmount" v-model="betAmount" :min="val.SD.minBet" :oninput="'estAmtCount('+fqVal.id+3+')'" :max="val.SD.maxBet">
                                                                                            <span class="input-group-text col-8">Est. Return &nbsp;<b :id="'estReturn'+fqVal.id+3">0.00</b></span>
                                                                                        </div>
                                                                                    </ul>
                                                                                    <div class="p-2">
                                                                                        <div class="d-grid gap-2">
                                                                                            <button type="submit" class="btn btn-dark btn-sm btn-fluid fw-bold" :id="'betBtn('+fqVal.id+3+')'" :onclick="'fqSubmit('+fqVal.id+3+')'" style="font-size:1.2rem">Place Bet</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                    ...
                                                                    <div class="row" v-if="cqVal.status == 1" :id="'cqForm'+cqVal.id+aindex">
                                                                            ...
                                                                            <ul>
                                                                                ...
                                                                                <li>Return Value: {{ answer.returnValue }}</li>
                                                                                    <input type="hidden" name="userId" :value="val.sessionUser">
                                                                                    <input type="hidden" name="quesId" :value="cqVal.id">
                                                                                    <input type="hidden" name="answerId" :value="cqVal.quesId">
                                                                                    <input type="hidden" name="answer" :value="answer.answer">
                                                                                    <input :id="'answerRate'+cqVal.id+aindex"  type="hidden" name="answerRate" :value="answer.returnValue">
                                                                                    <input type="hidden" name="matchId" :value="mlVal.id">
                                                                                    <input type="hidden" name="tournament" :value="mlVal.tournament">
                                                                                <div class="input-group mb-3 row">
                                                                                    <input required type="number" :id="'betAmount'+cqVal.id+aindex"  class="form-control col-4" placeholder="0" name="betAmount" :oninput="'estAmtCount('+cqVal.id+aindex+')'" v-model="betAmount" :min="val.SD.minBet" :max="val.SD.maxBet">
                                                                                    <span class="input-group-text col-8">Est. Return &nbsp;<b :id="'estReturn'+cqVal.id+aindex">0.00</b></span>
                                                                                </div>
                                                                            </ul>
                                                                            <div class="p-2">
                                                                                <div class="d-grid gap-2">
                                                                                    <button type="submit" class="btn btn-dark btn-sm btn-fluid fw-bold" :id="'betBtn('+cqVal.id+aindex+')'" :onclick="'cqSubmit('+cqVal.id+aindex+')'"  style="font-size:1.2rem">Place Bet</button>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                            ...
                                                                            <div class="row" v-if="fqVal.status == 1" :id="'sfqForm'+fqVal.id+tindex">
                                                                                <form method="post" action="javascript:void(0)" class="form col-12 col-md-10 mx-auto">
                                                                                    ...
                                                                                    <ul>
                                                                                        ...
                                                                                        <input type="hidden" name="answerId" :value="fqVal.quesId">
                                                                                        <input type="hidden" name="answer" :value="team.name">
                                                                                        <input :id="'sanswerRate'+fqVal.id+tindex"  type="hidden" name="answerRate" :value="team.value">
                                                                                        <input type="hidden" name="matchId" :value="mlVal.id">
                                                                                        <input type="hidden" name="tournament" :value="mlVal.tournament">
                                                                                        <div class="input-group mb-3 row">
                                                                                            <input required type="number" class="form-control col-4" placeholder="0" name="betAmount"  :id="'sbetAmount'+fqVal.id+tindex" v-model="betAmount" :min="val.SD.minBet" :oninput="'sestAmtCount('+fqVal.id+tindex+')'"  :max="val.SD.maxBet">
                                                                                            <span class="input-group-text col-8">Est. Return &nbsp;<b :id="'sestReturn'+fqVal.id+tindex">0.00</b></span>
                                                                                        </div>
                                                                                    </ul>
                                                                                    <div class="p-2">
                                                                                        <div class="d-grid gap-2">
                                                                                            <button :id="'sbetBtn'+fqVal.id+tindex" type="submit" class="btn btn-dark btn-sm btn-fluid fw-bold"  :onclick="'sfqSubmit('+fqVal.id+tindex+')'" style="font-size:1.2rem">Place Bet</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                            ...
                                                                            <div class="row" v-if="fqVal.status == 1" :id="'sfqForm'+fqVal.id+3">
                                                                                <form method="post" action="javascript:void(0)" class="form col-12 col-md-10 mx-auto">
                                                                                    ...
                                                                                    <ul>
                                                                                        ...
                                                                                        <input type="hidden" name="answerId" :value="fqVal.quesId">
                                                                                        <input type="hidden" name="answer" value="draw">
                                                                                        <input  :id="'sanswerRate'+fqVal.id+3" type="hidden" name="answerRate" :value="fqVal.draw">
                                                                                        <input type="hidden" name="matchId" :value="mlVal.id">
                                                                                        <input type="hidden" name="tournament" :value="mlVal.tournament">
                                                                                        <div class="input-group mb-3 row">
                                                                                            <input required type="number" class="form-control col-4" placeholder="0" name="betAmount" :id="'sbetAmount'+fqVal.id+3"  v-model="betAmount" :min="val.SD.minBet" :oninput="'sestAmtCount('+fqVal.id+3+')'" :max="val.SD.maxBet">
                                                                                            <span class="input-group-text col-8">Est. Return &nbsp;<b :id="'sestReturn'+fqVal.id+3">0.00</b></span>
                                                                                        </div>
                                                                                    </ul>
                                                                                    <div class="p-2">
                                                                                        <div class="d-grid gap-2">
                                                                                            <button type="submit" class="btn btn-dark btn-sm btn-fluid fw-bold" :id="'sbetBtn'+fqVal.id+3" :onclick="'sfqSubmit('+fqVal.id+3+')'"  style="font-size:1.2rem">Place Bet</button>
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                    ...
                                                                    <div class="row" v-if="cqVal.status == 1" :id="'scqForm'+cqVal.id+aindex">
                                                                            ...
                                                                            <ul>
                                                                                ...
                                                                                <li>Return Value: {{ answer.returnValue }}</li>
                                                                                    ...
                                                                                    <input type="hidden" name="answerId" :value="cqVal.quesId">
                                                                                    <input type="hidden" name="answer" :value="answer.answer">
                                                                                    <input :id="'sanswerRate'+cqVal.id+aindex" type="hidden" name="answerRate" :value="answer.returnValue">
                                                                                    <input type="hidden" name="matchId" :value="mlVal.id">
                                                                                    <input type="hidden" name="tournament" :value="mlVal.tournament">
                                                                                <div class="input-group mb-3 row">
                                                                                    <input required type="number" :id="'sbetAmount'+cqVal.id+aindex" class="form-control col-4" placeholder="0" :oninput="'sestAmtCount('+cqVal.id+aindex+')'"  name="betAmount" v-model="betAmount" :min="val.SD.minBet" :max="val.SD.maxBet">
                                                                                    <span class="input-group-text col-8">Est. Return &nbsp;<b :id="'sestReturn'+cqVal.id+aindex">0.00</b></span>
                                                                                </div>
                                                                            </ul>
                                                                            <div class="p-2">
                                                                                <div class="d-grid gap-2">
                                                                                    <button type="submit" class="btn btn-dark btn-sm btn-fluid fw-bold" :id="'sbetBtn'+cqVal.id+aindex" :onclick="'scqSubmit('+cqVal.id+aindex+')'" style="font-size:1.2rem">Place Bet</button>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    </div>
